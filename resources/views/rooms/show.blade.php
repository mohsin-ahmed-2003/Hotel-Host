...
@section('content')
    <div class="room-show-page">
        ...
        @if(isset($similarRooms) && $similarRooms->count() > 0)
            <section class="room-section" style="margin-top: 60px;">
                <div class="section-header-wrapper" style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 24px;">
                    <h2 class="section-title" style="margin-bottom: 0;"><i class="fas fa-home"></i> Similar Properties</h2>
