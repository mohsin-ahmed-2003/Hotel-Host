...
@section('content')
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-1"
            ...
            <h2 class="fw-bold m-0" style="font-weight: bold; margin: 0; font-size: 28px; color: #1e293b;">Add Subscription
                Plan</h2>
        ...
        <p class="text-muted small mb-4" style="color: #6c757d; font-size: 15px; margin-bottom: 1.5rem;">Create a new tier
            for host subscriptions.</p>

        <div class="card" style="max-width: 940px; margin-top: 20px;">
            <div class="card-body">
                @if($errors->any())
                    ...
                    <div class="form-grid">
                            ...
                            <div style="display: flex; gap: 20px;">
                                <div style="flex: 1;">
                                    ...
                                    <select name="currency" class="form-control" required>
                                        @php
                                            $defaultCurrency = \App\Models\SiteSetting::get('default_currency', 'USD');
                                        @endphp
                                        @foreach($currencies as $cur)
                                            <option value="{{ $cur->currency_code }}" {{ $defaultCurrency === $cur->currency_code ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="cancellations_allowed" class="form-control"
                                value="{{ old('cancellations_allowed', 0) }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="cancellation_fee_reduction" class="form-control"
                                value="{{ old('cancellation_fee_reduction', 0) }}" required>
                        </div>
