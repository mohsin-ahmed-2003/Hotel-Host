    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('admin.reviews.index') }}"
                class="nav-item {{ request()->routeIs('admin.reviews*') ? 'active' : '' }}" data-tooltip="Manage Reviews">
                <span class="nav-icon">
                    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path>
                    </svg>
                </span>
                <span class="nav-label">Manage Reviews</span>
            </a>
            ...
            <a href="{{ route('admin.currency-rates.index') }}"
                class="nav-item {{ request()->routeIs('admin.currency-rates*') ? 'active' : '' }}"
                data-tooltip="Manage Currency Rates">
                <span class="nav-icon">
                    <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
                    </svg>
                </span>
                <span class="nav-label">Currency Rates</span>
            </a>
